...
<p align="center">
 <a href="https://youtu.be/cxetjPSm3LA">
...
```brew install glfw glew glm assimp curl nlohmann-json```
    ...
    * __Windows__: 
Unfortunately, the source code for Stockfish and multiplayer support cannot be compiled on Windows machines.
...
4. Run:
    * Execute in the __build/output/bin__ directory: ```./CHESS_3D```
        ...
        * ```-multiplayer```: optional flag to attempt to join a multiplayer match
